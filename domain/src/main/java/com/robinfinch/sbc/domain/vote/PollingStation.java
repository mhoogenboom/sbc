...
public class PollingStation extends AggregatorClient {

    private final int minimumBlockSize;

    private int counter;

    public PollingStation(UserStore userStore, LedgerStore ledgerStore, Network network, int minimumBlockSize) {
